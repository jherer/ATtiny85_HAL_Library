...
void dump(sim_io_state_t *sim_io) {
    ...
    DEBUG_PRINTLN("--USI--", DEBUG_LAYER_SIM);
    DEBUG_PRINTLN_BIN("    USICR", sim_io->USICR_SIM, DEBUG_LAYER_SIM);
    DEBUG_PRINTLN_BIN("    USIDR", sim_io->USIDR_SIM, DEBUG_LAYER_SIM);
    DEBUG_PRINTLN_BIN("    USIBR", sim_io->USIBR_SIM, DEBUG_LAYER_SIM);
    DEBUG_PRINTLN_BIN("    USISR", sim_io->USISR_SIM, DEBUG_LAYER_SIM);
    DEBUG_PRINTLN("--PCINT--", DEBUG_LAYER_SIM);
    DEBUG_PRINTLN_BIN("    PCMSK", sim_io->PCMSK_SIM, DEBUG_LAYER_SIM);
